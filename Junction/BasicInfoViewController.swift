...
//  LinkedInXDcard
//
//  Created by 林晏竹 on 2017/10/26.
//  Copyright © 2017年 林晏竹. All rights reserved.
//

import UIKit

class BasicInfoViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, ValidatorProtocol {
    ...
    @IBAction func unwindToBasicInfoVC(sender: UIStoryboardSegue) {
        self.setValue(from: self.user)
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        default:
            print("BasicInfoVC ERROR: Unexpected pickerView")
        }
    }
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        default:
            print("BasicInfoVC: textField don't need pickerView")
        }
    }
    ...
    @objc private func scrollToTextField(_ notification: NSNotification) {
        if let keyboardSize = (notification.userInfo?[UIKeyboardFrameEndUserInfoKey] as? CGRect)?.size {
            ...
            print("ERROR: BasicInfoVC cannot get keyboard size")
        }
    }
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        if let pickedImage = info[UIImagePickerControllerOriginalImage] as? UIImage {
            ...
            print("BasicInfoVC: PickedImage is nil")
    ...
    // MARK: - Validator Functńons
    func validate(_ textField: UITextField) {
        
        // Phone_numberTextField, masterTextField don't need validation
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        default:
            print("BasicInfoVC: Unexpected segue identifier!")
        }
    }
    ...
    private func setValue(from user: User?) {
        guard let user = user else {
            print("BasicInfoVC: setValue(from:) has nil user")
            return
        }
