...
//  LinkedInXDcard
//
//  Created by 林晏竹 on 2017/10/29.
//  Copyright © 2017年 林晏竹. All rights reserved.
//

import UIKit

class SkillViewController: UIViewController, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UIGestureRecognizerDelegate, UITextViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, ValidatorProtocol {
    ...
    @IBAction func unwindToSkillVC(sender: UIStoryboardSegue) {
        self.setValue(from: self.user)
    }
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        default:
            print("SkillVC: \(#function) textField don't need pickerView")
        }
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        default:
            print("SkillVC: \(#function) unexpected pickerView")
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        default:
            print("SkillVC: cellForItemAt() unexpected collectionView.")
        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        default:
            print("SkillVC: didSelectItemAt() unexpected cell.")
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
        ...
        default:
            print("SkillVC: didDeselectItemAt() unexpected cell.")
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "showInterestVC":
            guard let interestVC = segue.destination as? InterestViewController else {
                fatalError("\(segue.identifier!) segue's destination ERROR! Destination: \(segue.destination)")
            }
            interestVC.user = self.update(user: self.user)
            
        case "unwindToBasicInfoVC":
            guard let basicInfoVC = segue.destination as? BasicInfoViewController else {
                fatalError("\(segue.identifier!) segue's destination ERROR! Destination: \(segue.destination)")
            }
            basicInfoVC.user = self.update(user: self.user)
            
        default:
            print("SkillVC: Unexpected segue identifier!")
        }
    }
    ...
    private func setValue(from user: User?) {
        guard let user = user else {
            print("SkillVC: \(#function) has nil user")
            return
        }
